...
function AboutMeInfo(props) {
  return (
    <div className='rotate'>
      ...
      <p className='screen-text speech'>
        I alwyas wanted to create something thats why I started to learn CSS,
        Js, React and many others which I didn't even hear about a few years
        ago. When I got into it I knew that I want to turn it into a full-time
        job.
      </p>
